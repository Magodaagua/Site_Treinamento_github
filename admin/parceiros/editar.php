<?php
    ...
    */}else{
        $query_parceiro= "UPDATE parceiro SET Nome=:Nome, Descricao=:Descricao, link=:link, imagem=:imagem WHERE ID_parceiro=:ID_parceiro";
        ...
        $edit_parceiro ->bindParam(':imagem', $dados['imagem'], PDO::PARAM_STR);
