...
--
-- Host: 127.0.0.1
-- Tempo de geração: 15/09/2023 às 22:14
...
INSERT INTO `categoria` (`Nome_cat`, `imagem`) VALUES
('Administração', '0'),
('Atendimento', '0'),
('Contabilidade', '0'),
('Informática', '0'),
...
INSERT INTO `curso` (`ID_curso`, `Nome`, `Categoria`, `Subcategoria`, `Descricao`, `Datadecriacao`, `imagem`) VALUES
(1, 'Linguagem C', 'Informática', 'Programação', 'Curso para ensinar C básico', '2023-08-20', 'csharp.png'),
(2, 'Python', 'Informática', 'Programação', 'Curso para ensinar Python básico', '2022-12-12', '2.png'),
...
(12, 'teste4', 'Informática', 'sadasd', 'O NDD Print é uma solução internacional voltada para o mercado de impressão, com tecnologias para provedores de outsourcing de impressão e clientes desses provedores.', '2023-09-01', 'papelaria.png'),
(26, 'Victor', 'Informática', 'sadasd', 'Curso para ensinar Java básico', '2023-10-01', '20180711075154_7085992915_D.png');
...
(9, 'teste', 'Unity é uma ferramenta que permite criar videojogos para diversas plataformas (PC, consolas, mobile, VR e AR) utilizando um editor visual e programação através de scripting,', 'https://app.printwayy.com/Account/Login?ReturnUrl=/', ''),
(15, 'Carlos Nascimento', 'Unity é uma ferramenta que permite criar videojogos para diversas plataformas (PC, consolas, mobile, VR e AR) utilizando um editor visual e programação através de scripting,', 'https://unity.com/pt', '20180711075154_7085992915_D.png');
...
--
ALTER TABLE `curso`
  MODIFY `ID_curso` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `curso`
  ADD CONSTRAINT `curso_ibfk_1` FOREIGN KEY (`Categoria`) REFERENCES `categoria` (`Nome_cat`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
